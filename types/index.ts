export type OrganizationType = 'Publisher' | 'Asset Owner' | 'Subscriber' | 'Delegate'
export type OrganizationStatus = 'Verified' | 'Pending' | 'Suspended'
export type UserRole = 'Admin' | 'Viewer' | 'Publisher' | 'Asset Owner' | 'Subscriber' | 'Auditor' | 'Restricted' | 'Analytics' | 'Tax' | 'Integration' | 'Ops' | 'Signer' | 'IR' | 'Risk'
